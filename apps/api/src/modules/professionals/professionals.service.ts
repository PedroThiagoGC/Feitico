...
export class ProfessionalsService {
  ...
  async findServices(professionalId: string) {
    ...
    if (error) {
      this.logger.error(`Error loading services for professional ${professionalId}`, error);
  ...
  async findAvailability(professionalId: string) {
    ...
    if (error) {
      this.logger.error(`Error loading availability for professional ${professionalId}`, error);
  ...
  async createAvailability(professionalId: string, payload: any) {
    ...
    if (error) {
      this.logger.error(`Error creating availability for professional ${professionalId}`, error);
  ...
  async findExceptions(professionalId: string, month?: string) {
    ...
    if (error) {
      this.logger.error(`Error loading exceptions for professional ${professionalId}`, error);
  ...
  async createException(professionalId: string, payload: any) {
    ...
    if (error) {
      this.logger.error(`Error creating exception for professional ${professionalId}`, error);
  ...
  async createServiceLink(professionalId: string, payload: any) {
    ...
    if (error) {
      this.logger.error(`Error creating service link for professional ${professionalId}`, error);
